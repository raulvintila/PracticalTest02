...
public class ServerThread extends Thread {
    ...
    private HashMap<String, RequestResponse> data = null;
    ...
    public synchronized void setData(String city, RequestResponse requestResponse) {
        this.data.put(city, requestResponse);
    }

    public synchronized HashMap<String, RequestResponse> getData() {
        return data;
    }
